...
typedef struct AUTHOIDC AUTHOIDC;
...
typedef struct RPC_OIDC_GET_LOGGED_IN_USER RPC_OIDC_GET_LOGGED_IN_USER;
typedef struct RPC_OIDC_LOGOUT_ALL_RESULT RPC_OIDC_LOGOUT_ALL_RESULT;
